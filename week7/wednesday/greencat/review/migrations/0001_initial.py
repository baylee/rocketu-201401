...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'review_review', (
            ...
            ('product', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['storefront.Product'])),
    ...
    models = {
        ...
        u'review.review': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'product': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['storefront.Product']"})
        },
