...
from dropbox.api.resources import MediaResource
from lecture.api.resources import StudentResource, ClassResource, VersionResource, StudentProjectResource
...
urlpatterns = patterns('',
    ...
    url(r'^app/', 'registrar.views.angular', name='angular'),
